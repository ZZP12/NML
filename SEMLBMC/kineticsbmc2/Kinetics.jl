function calculate_kinetics(X, data_dictionary)
	...
	rnx_rate_vector[1] = kcat[1]*X[12]*X[2]/(MonodK["MonodK~rnx1~met_A_e"]+X[2])
	rnx_rate_vector[2] = kcat[2]*X[13]*X[6]/(MonodK["MonodK~rnx2~met_B_c"]+X[6])
	rnx_rate_vector[3] = kcat[3]*X[14]*X[7]/(MonodK["MonodK~rnx3~met_C_c"]+X[7])
	rnx_rate_vector[4] = kcat[4]*X[8]*X[5]/(MonodK["MonodK~rnx4~met_A_c"]+X[5])
	rnx_rate_vector[5] = kcat[5]*X[11]*X[6]/(MonodK["MonodK~rnx5~met_B_c"]+X[6])
	rnx_rate_vector[6] = kcat[6]*X[9]*X[5]/(MonodK["MonodK~rnx6~met_A_c"]+X[5])
	rnx_rate_vector[7] = kcat[7]*X[10]*X[7]/(MonodK["MonodK~rnx7~met_C_c"]+X[7])
	...
	mRNA_E4_c_met_B_c = W_value_dict["W~met_B_c~mRNA_E4_c"] * X[6]^coop/((disassociation_constant_dict["KD~met_B_c"])^coop+X[6]^coop)
	up_action_on_mRNA_E4_c = mRNA_E4_c_met_B_c 
	...
	mRNA_E2_c_met_A_c = W_value_dict["W~met_A_c~mRNA_E2_c"] * X[5]^coop/((disassociation_constant_dict["KD~met_A_c"])^coop+X[5]^coop)
	up_action_on_mRNA_E2_c = mRNA_E2_c_met_A_c 
	...
	mRNA_E3_c_met_C_c = W_value_dict["W~met_C_c~mRNA_E3_c"] * X[7]^coop/((disassociation_constant_dict["KD~met_C_c"])^coop+X[7]^coop)
	up_action_on_mRNA_E3_c = mRNA_E3_c_met_C_c 
	...
	mRNA_TA_c_met_A_e = W_value_dict["W~met_A_e~mRNA_TA_c"] * X[2]^coop/((disassociation_constant_dict["KD~met_A_e"])^coop+X[2]^coop)
	up_action_on_mRNA_TA_c = mRNA_TA_c_met_A_e 
	...
	mRNA_TB_c_met_B_c = W_value_dict["W~met_B_c~mRNA_TB_c"] * X[6]^coop/((disassociation_constant_dict["KD~met_B_c"])^coop+X[6]^coop)
	up_action_on_mRNA_TB_c = mRNA_TB_c_met_B_c 
	...
	mRNA_E1_c_met_A_c = W_value_dict["W~met_A_c~mRNA_E1_c"] * X[5]^coop/((disassociation_constant_dict["KD~met_A_c"])^coop+X[5]^coop)
	up_action_on_mRNA_E1_c = mRNA_E1_c_met_A_c 
	...
	mRNA_TC_c_met_C_c = W_value_dict["W~met_C_c~mRNA_TC_c"] * X[7]^coop/((disassociation_constant_dict["KD~met_C_c"])^coop+X[7]^coop)
	up_action_on_mRNA_TC_c = mRNA_TC_c_met_C_c 
