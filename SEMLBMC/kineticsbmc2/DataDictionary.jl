function generate_model_parameters_dictionary()
	...
	all_species_dict["met_C_e"] = 4
	all_species_dict["met_B_c"] = 6
	all_species_dict["p_TA_c"] = 12
	all_species_dict["met_A_c"] = 5
	all_species_dict["p_TB_c"] = 13
	all_species_dict["met_C_c"] = 7
	...
	kcat_signaling[1] = 1.1e-3  # kcat: 1.0*met_A_e<uptake:1.0*p_TA_c>1.0*met_A_c
	kcat_signaling[2] = 8e-4  # kcat: 1.0*met_B_c<secrete:1.0*p_TB_c>1.0*met_B_e
	kcat_signaling[3] = 9e-4  # kcat: 1.0*met_C_c<secrete:1.0*p_TC_c>1.0*met_C_e
	kcat_signaling[4] = 1.8e-4  # kcat: 1.0*met_A_c<catalyze:1.0*p_E1_c>1.0*met_B_c
	kcat_signaling[5] = 1e-4  # kcat: 1.0*met_B_c<catalyze:1.0*p_E4_c>1.0*met_A_c
	kcat_signaling[6] = 1e-4  # kcat: 1.0*met_A_c<catalyze:1.0*p_E2_c>1.0*met_C_c
	kcat_signaling[7] = 1e-4  # kcat: 1.0*met_C_c<catalyze:1.0*p_E3_c>1.0*met_B_c
	...
	MonodAffinityConstantDict["MonodK~rnx1~met_A_e"] = 0.1
	MonodAffinityConstantDict["MonodK~rnx2~met_B_c"] = 0.1
	MonodAffinityConstantDict["MonodK~rnx3~met_C_c"] = 0.1
	MonodAffinityConstantDict["MonodK~rnx4~met_A_c"] = 0.1
	MonodAffinityConstantDict["MonodK~rnx5~met_B_c"] = 0.1
	MonodAffinityConstantDict["MonodK~rnx6~met_A_c"] = 0.1
	MonodAffinityConstantDict["MonodK~rnx7~met_C_c"] = 0.1


	# W_value in transcription control term, nomenclature: W_targetmRNA_actor
	W_value_dict = Dict{String, Float64}()
	W_value_dict["W~met_B_c~mRNA_E4_c"] = 0.1
	W_value_dict["W~met_A_c~mRNA_E2_c"] = 0.7
	W_value_dict["W~met_C_c~mRNA_E3_c"] = 0.2
	W_value_dict["W~met_A_e~mRNA_TA_c"] = 0.1
	W_value_dict["W~met_B_c~mRNA_TB_c"] = 1.0
	W_value_dict["W~met_A_c~mRNA_E1_c"] = 0.6
	W_value_dict["W~met_C_c~mRNA_TC_c"] = 1.1
	...
	transferFunctionDisassociationConstantDict["KD~met_B_c"] = 1.0
	transferFunctionDisassociationConstantDict["KD~met_A_c"] = 1.0
	transferFunctionDisassociationConstantDict["KD~met_C_c"] = 1.0
	transferFunctionDisassociationConstantDict["KD~met_A_e"] = 1.0
	transferFunctionDisassociationConstantDict["KD~met_B_c"] = 1.0
	transferFunctionDisassociationConstantDict["KD~met_A_c"] = 1.0
	transferFunctionDisassociationConstantDict["KD~met_C_c"] = 1.0
